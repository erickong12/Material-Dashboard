                    ...
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <input class="form-control @error('npm') is-invalid @enderror" type="text" value="{{old('npm')}}" name="npm" placeholder="NPM" required="true" aria-required="true" />
                                        @error('npm')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <input class="mx-2" type="radio" name="jk" value="L" @if(old('jk')=="L" ) checked : "" ; @endif required="true" aria-required="true" />Laki-laki
                                        <input class="mx-2" type="radio" name="jk" value="P" @if(old('jk')=="P" ) checked : "" ; @endif required="true" aria-required="true" />Perempuan
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <input class="form-control @error('tempat_lahir') is-invalid @enderror" type="text" value="{{old('tempat_lahir')}}" name="tempat_lahir" placeholder="tempat lahir" required="true" aria-required="true" />
                                        @error('tempat_lahir')
