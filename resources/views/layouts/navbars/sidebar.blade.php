  ...
  <div class="sidebar-wrapper">
    <ul class="nav">
      ...
      <li class="nav-item {{ ($activePage == 'profile' || $activePage == 'user-management') ? ' active' : '' }}">
        ...
        <div class="collapse {{ $activePage == '' ? '' : 'show' }}" id="laravelExample">
          <ul class="nav">
            ...
            <li class="nav-item{{ $activePage == 'mahasiswa' ? ' active' : '' }}">
              <a class="nav-link" href="{{ route('mahasiswa.index') }}">
                ...
                <span class="sidebar-normal"> {{ __('Mahasiswa Management') }} </span>
              </a>
            </li>
            <li class="nav-item{{ $activePage == 'dosen' ? ' active' : '' }}">
              <a class="nav-link" href="{{ route('dosen.index') }}">
                <span class="sidebar-mini"> DO </span>
                <span class="sidebar-normal"> {{ __('Dosen Management') }} </span>
              </a>
            </li>
          </ul>
        </div>
